...
export const caseStudyContent: CaseStudyContentMap = {
  weready: {
    ...
    heroMeta: [
      ...
      {
        label: 'Focus',
        value: 'Multi-agent AI coordination, startup intelligence automation, evidence-based scoring',
      },
      {
        label: 'Built With',
        value: 'Claude Code + Codex CLI + Traycer.ai orchestration, Next.js, Supabase',
      },
    ],
    problem: {
      eyebrow: 'The Problem',
      ...
      cards: [
        {
          ...
          description: 'UX/UI design system implementation and architectural decisions',
          icon: {
            type: 'image',
    ...
    showcase: {
      ...
      items: [
        {
          image: '/images/projects/weready/pic1.png',
        ...
        {
          image: '/images/projects/weready/pic2.png',
        ...
        {
          image: '/images/projects/weready/pic3.png',
  ...
  listingpal: {
    ...
    heroMeta: [
      ...
      {
        label: 'Built With',
        value: 'Claude Code + Codex CLI + Traycer.ai orchestration, React, OpenAI API',
      },
    ],
    problem: {
      eyebrow: 'The Problem',
    ...
    toolkit: {
      ...
      cards: [
        {
          title: 'Claude Code CLI',
          description: 'Real estate UX patterns and marketing automation workflow design',
          icon: {
            type: 'image',
            src: 'https://assets-global.website-files.com/6500ed5c1fd67be80b31c5c9/659a7b05e0e3d8b84ee12cc9_Claude_Logo.svg',
            alt: 'Claude AI',
        ...
        {
          title: 'Codex CLI',
          description: 'MLS integration and campaign generation pipeline development',
          icon: {
            type: 'image',
            src: 'https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png',
            alt: 'GitHub Codex',
        ...
        {
          title: 'Gemini + Traycer.ai',
          description: 'AgentSelect™ framework architecture and real estate workflow planning',
          icon: {
            type: 'image',
            src: 'https://upload.wikimedia.org/wikipedia/commons/8/8a/Google_Gemini_logo.svg',
            alt: 'Google Gemini',
        ...
        {
          title: 'Ollama',
          description: 'Local testing and content generation optimization for real estate copy',
          icon: {
            type: 'image',
            src: 'https://ollama.com/public/ollama.png',
            alt: 'Ollama',
        ...
        {
          title: 'VS Code + Roo',
          description: 'Integrated development environment with AI assistance for rapid prototyping',
          icon: {
            type: 'image',
            src: 'https://code.visualstudio.com/assets/images/code-stable.png',
            alt: 'VS Code',
    ...
    showcase: {
      ...
      title: 'From multi-agent coordination to real estate marketing automation',
      items: [
        {
          image: '/images/projects/listingpal/pic1.png',
        ...
        {
          image: '/images/projects/listingpal/pic2.png',
        ...
        {
          image: '/images/projects/listingpal/pic3.png',
  ...
  echo: {
    ...
    heroMeta: [
      ...
      {
        label: 'Focus',
        value: 'Screenshot automation, MLR compliance, pharmaceutical QA workflows',
      },
      {
        label: 'Built With',
        value: 'Claude Code + Codex CLI + Traycer.ai orchestration, Puppeteer, Node.js, AWS',
      },
    ],
    problem: {
      eyebrow: 'The Problem',
    ...
    toolkit: {
      ...
      cards: [
        {
          title: 'Claude Code CLI',
          description: 'Pharma workflow analysis and automation architecture design',
          icon: {
            type: 'image',
            src: 'https://assets-global.website-files.com/6500ed5c1fd67be80b31c5c9/659a7b05e0e3d8b84ee12cc9_Claude_Logo.svg',
            alt: 'Claude AI',
        ...
        {
          title: 'Codex CLI',
          description: 'Screenshot pipeline and browser automation implementation',
          icon: {
            type: 'image',
            src: 'https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png',
            alt: 'GitHub Codex',
        ...
        {
          title: 'Gemini + Traycer.ai',
          description: 'System architecture and pharmaceutical compliance planning',
          icon: {
            type: 'image',
            src: 'https://upload.wikimedia.org/wikipedia/commons/8/8a/Google_Gemini_logo.svg',
            alt: 'Google Gemini',
    ...
    showcase: {
      ...
      items: [
        {
          image: '/images/projects/echo/pic1.png',
        ...
        {
          image: '/images/projects/echo/pic2.png',
        ...
        {
          image: '/images/projects/echo/pic3.png',
  ...
  briefflow: {
    ...
    heroMeta: [
      ...
      {
        label: 'Focus',
        value: 'AI-powered briefing, client workflow optimization, creative process automation',
      },
      {
        label: 'Built With',
        value: 'Claude Code + Codex CLI + Traycer.ai orchestration, Next.js, Supabase',
    ...
    toolkit: {
      ...
      cards: [
        {
          title: 'Claude Code CLI',
          description: 'Marketing workflow analysis and AI briefing architecture design',
          icon: {
            type: 'image',
            src: 'https://assets-global.website-files.com/6500ed5c1fd67be80b31c5c9/659a7b05e0e3d8b84ee12cc9_Claude_Logo.svg',
            alt: 'Claude AI',
        ...
        {
          title: 'Codex CLI',
          description: 'Form logic implementation and client workflow automation',
          icon: {
            type: 'image',
            src: 'https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png',
            alt: 'GitHub Codex',
        ...
        {
          title: 'Ollama',
          description: 'Local testing and optimization for brief generation quality',
          icon: {
            type: 'image',
            src: 'https://ollama.com/public/ollama.png',
            alt: 'Ollama',
      ...
      milestones: [
        {
          ...
          stats: [
            ...
            {
              label: 'Focus:',
              value: 'Creative brief inefficiencies and client communication gaps',
            },
          ],
        },
        {
    ...
    showcase: {
      ...
      title: 'From multi-agent coordination to marketing workflow transformation',
      items: [
        {
          image: '/images/projects/briefflow/pic1.png',
        ...
        {
          image: '/images/projects/briefflow/pic2.png',
        ...
        {
          image: '/images/projects/briefflow/pic3.png',
