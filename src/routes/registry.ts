...
type LazyRouteMap = Partial<Record<RouteComponentId, () => Promise<RouteModule>>>;

const lazyRouteLoaders: LazyRouteMap = {
  projects: () => import('./projects').then((mod) => mod.default),
  'project-weready': () => import('./projectWeReady').then((mod) => mod.default),
  'project-listingpal': () => import('./projectListingPal').then((mod) => mod.default),
  'project-echo': () => import('./projectEcho').then((mod) => mod.default),
  'project-briefflow': () => import('./projectBriefFlow').then((mod) => mod.default),
  'project-clockit': () => import('./projectClockIt').then((mod) => mod.default),
...
export const loadRouteModule = async (routeId: RouteComponentId): Promise<RouteModule | null> => {
